                ...
                <table id="table" data-toolbar="#toolbar" data-toolbar="#toolbar" class="table-striped"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-halign="center" data-field="user_id_str" data-width="10" data-align="left"
                                data-sortable="true">utilisateur</th>
                            <th data-halign="center" data-field="action" data-width="10" data-align="left"
                                data-sortable="true">action</th>
                            <th data-halign="center" data-field="routeName" data-width="10" data-align="left"
                                data-sortable="true">routeName</th>
                            <th data-halign="center" data-field="uri" data-width="10" data-align="left"
                                data-sortable="true">uri</th>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Suppression LogHead</h1>
    ...
    <script>
        ...
        function actionFormatter(value, row) {
            ...
            return '<div class="dropdown">' +
                ...
                '<li><a class="dropdown-item" href="' + '{{ route('rras3k.LogDetail.index') }}?logHead=' + row
                .id + '"><i class="bi bi-pencil"></i> Evenements</a></li>' +
                '</ul>' +
                '</div>'
        }
